...
$(document).ready(function() {
	...
	var oTable = $('.tb-data').dataTable( {
		...
		"bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "../www/api/datatables/location",
				...
				<td>
                	<div id="c-content">
                        ...
                        <div id="c-content-toolbar">
                        	<button  id="frm-location-new" class="toolbar-minibutton" type="button" data-toggle="modal" data-target="#mdl-frm-location">New</button>
                        </div>
                        <div id="c-frm-container">
                        	<div id="frm-alert"></div>
                        	<form id="frm-location" name="frm-location" class="table-model" data-table="location" action="" method="post">
