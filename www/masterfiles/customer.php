...
$(document).ready(function() {
	...
	var oTable = $('.tb-data').dataTable( {
		...
		"bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "../www/api/datatables/v/customer",
	//	"sAjaxSource": "../www/test/datatable_test.php"
		"fnHeaderCallback":  function( nHead, aData, iStart, iEnd, aiDisplay ) { 
				
				var title = ["Code","Descriptor","cPerson","cTitle","Salesman","Terms","Balance","Email"];
				...
				<td>
                	<div id="c-content">
                        ...
                        <div id="c-content-toolbar">
                        	<button  id="frm-customer-new" class="toolbar-minibutton" type="button" data-toggle="modal" data-target="#mdl-frm-customer">New</button>
                        </div>
                        <div id="c-frm-container">
                        	<div id="frm-alert"></div>
                        	<form id="frm-customer" name="frm-supplier" class="table-model" data-table="customer" action="" method="post">
                            	<table cellpadding="0" cellspacing="0" border="0">
                                	<tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" id="balance" name="balance" style="width:100px;" value="0.00" min="0" step="0.5" max="1000000000" disabled  />
                                        </tr>
                                        <tr>
